class PagesController < ApplicationController
  ...
  def index_per_year
    ...
    Tirage.all.each do |tirage_object|
      @array_of_tiragearrays << [tirage_object.date, tirage_object.number1, tirage_object.number2, tirage_object.number3, tirage_object.number4, tirage_object.number5, tirage_object.star1, tirage_object.star2, tirage_object.prize]
    end
